...
export const searchGlossary: Resource[] = [
  ...
  },
  {
    ...
    body: [
      "Duplicate URLs are normal and mostly accidental. Tracking parameters, filter combinations, uppercase and lowercase paths, with and without a trailing slash, print views can each serve the same content at a different address. Left undeclared, links and relevance signals divide between them and none of the versions is as strong as the single page should have been.",
